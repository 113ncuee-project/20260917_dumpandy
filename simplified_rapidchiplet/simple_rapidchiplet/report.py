...
def _csv_row(row: EvaluationResult) -> dict[str, object]:
    return {
        ...
        "power_fixed_utilization_w": _csv_float(row.power_fixed_utilization_w),
        "energy_per_inference_j": _csv_float(row.energy_per_inference_j),
